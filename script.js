document.addEventListener("DOMContentLoaded", () => {
    ...
    let images = ["imageone.png", "imagetwo.png", "imagethree.png"];
    let currentIndex = 0;
    ...
    window.addEventListener('resize', () => {
        ...
        usernamelogin.addEventListener("change", () => {
            if (emailInput.style.display==="none") {
                usernamelogin.querySelector("p").textContent = "Or login with username";
                username.style.display = "none";
                emailInput.style.display = "flex";
               
            } else {
                usernamelogin.querySelector("p").textContent = "Or login with email";
    ...
    // const signup=document.querySelector(".signupinfo")
